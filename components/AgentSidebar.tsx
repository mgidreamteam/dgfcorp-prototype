            ...
            <div className="shrink-0 p-4 border-b border-zinc-800 bg-black/80 backdrop-blur z-20 sticky top-0">
                ...
                <div className="relative">
                    <input
                        ...
                        disabled={isThinking}
                        placeholder="Ask HELO to add features or modify nodes..."
                ...
                <p className="text-[9px] text-zinc-500 mt-2 text-center opacity-80 leading-tight">HELO actively parses instructions into topological parameters.</p>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-2">
                {agentLogs.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-full text-center opacity-70 mt-10">
                        ...
                        <p className="text-zinc-500 text-xs mt-2">No events recorded yet. Construct models via HELO or UI tools.</p>
                    </div>
                ) : (
                    agentLogs.map(log => (
