       ...
       <div onClick={(e) => e.stopPropagation()} className="flex flex-col h-full overflow-hidden">
        ...
        <div className="p-8 overflow-y-auto space-y-6 text-body">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-zinc-300 leading-relaxed">
              <li><span className="font-semibold text-zinc-200">Prompting Hilo:</span> Use the main text area in the right-hand panel to describe the product you want to create. Be as descriptive as possible. You can also upload specifications from a `.txt` or `.md` file using the "Upload Specs" button.</li>
              <li><span className="font-semibold text-zinc-200">Iterative Design:</span> Hilo remembers the context of your current project. You can provide follow-up prompts like "make the casing out of aluminum instead" to refine the design without starting over.</li>
              <li>
                <span className="font-semibold text-zinc-200">Design Modes:</span>
                <ul className="list-[circle] list-inside ml-4 mt-1">
                    <li><span className="font-medium text-zinc-200">Unconstrained (Default):</span> If you omit key details, Hilo will make reasonable, industry-standard assumptions to complete the design. These assumptions will be listed in the specifications.</li>
                    <li><span className="font-medium text-zinc-200">Constrained:</span> If you check this box, Hilo will require you to provide values for all critical parameters before proceeding.</li>
                </ul>
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-zinc-300 mb-2 leading-relaxed">Once you submit a prompt, Hilo executes a series of steps:</p>
            <ol className="list-decimal list-inside space-y-2 text-zinc-300 leading-relaxed">
              ...
              <li><span className="font-semibold text-zinc-200">Circuit & PCB:</span> If your design includes electronics, Hilo will generate a schematic and a printed circuit board layout.</li>
            </ol>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 text-zinc-300 leading-relaxed">
              ...
              <li><span className="font-semibold text-zinc-200">Retry with Guidance:</span> This is the recommended option. A dialog will appear, allowing you to give Hilo specific corrective feedback (e.g., "The render should show the product on a white background"). Hilo will use this new information to re-attempt only the failed step.</li>
            </ul>
          </section>
