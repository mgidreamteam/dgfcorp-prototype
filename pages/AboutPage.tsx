    ...
    return (
        <div className="animate-fade-in">
            <div className="max-w-5xl mx-auto px-6 py-12">
                ...
                <div className="mt-8 mb-16 max-w-7xl mx-auto w-full">
                    <h2 className="text-4xl font-bold text-white mb-10 text-center tracking-tight">Leadership</h2>
                    
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
                        {/* Vishnu Bio */}
                        <div className="bg-zinc-900/40 border border-zinc-800 rounded-2xl p-8 flex flex-col gap-8 relative overflow-hidden h-full">
                            <div className="spotlight-effect opacity-30"></div>
                            
                            <div className="w-full flex justify-between items-start relative z-10">
                                <div className="w-32 h-32 md:w-40 md:h-40 shrink-0 bg-zinc-800 rounded-xl flex items-center justify-center border border-zinc-700 shadow-xl overflow-hidden relative">
                                    <div className="absolute inset-0 bg-gradient-to-br from-zinc-700 to-zinc-900 w-full h-full flex flex-col items-center justify-center">
                                        ...
                                        <span className="text-zinc-600 font-bold tracking-widest uppercase text-center text-sm md:text-base">Vishnu<br/>Sundaresan</span>
                                    </div>
                                </div>
                                <a href="https://www.linkedin.com/in/vbsundaresan/" target="_blank" rel="noopener noreferrer" className="p-3 bg-zinc-800/50 hover:bg-zinc-800 border border-zinc-700 rounded-xl transition-colors shrink-0 group shadow-lg">
                            ...
                            <div className="flex-1 relative z-10">
                                <h3 className="text-2xl font-bold text-white flex items-center gap-3">
                                    Vishnu Sundaresan, Ph.D.
                                </h3>
                                <p className="text-zinc-400 font-medium uppercase tracking-widest text-sm mb-6 mt-2 flex items-center gap-2">
                            ...
                            <div className="w-full flex justify-between items-start relative z-10">
                                <div className="w-32 h-32 md:w-40 md:h-40 shrink-0 bg-zinc-800 rounded-xl flex items-center justify-center border border-zinc-700 shadow-xl overflow-hidden relative">
                                    <div className="absolute inset-0 bg-gradient-to-br from-zinc-700 to-zinc-900 w-full h-full flex flex-col items-center justify-center">
                                        ...
                                        <span className="text-zinc-600 font-bold tracking-widest uppercase text-sm md:text-base">Alan Clarke</span>
                                    </div>
                                </div>
                                <a href="https://www.linkedin.com/in/alan-clarke-81763511/" target="_blank" rel="noopener noreferrer" className="p-3 bg-zinc-800/50 hover:bg-zinc-800 border border-zinc-700 rounded-xl transition-colors shrink-0 group shadow-lg">
                                    <svg className="w-6 h-6 text-zinc-400 group-hover:text-[#0a66c2] transition-colors" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                                </a>
                            </div>
